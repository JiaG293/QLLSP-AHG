...
public class PDFUtils {
    ...
    public static void taoPhieuLuongNhanVien(String filePath, ObservableList<BangLuongNhanVien> listBLNV) {
        Document document = new Document();
        ...
        try {
            ...
            Font contentFont = new Font(BaseFont.createFont("src/main/resources/com/openjfx/qllspahg/fonts/vuArial.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED), 16);
            Font currencyFont = new Font(BaseFont.createFont("src/main/resources/com/openjfx/qllspahg/fonts/vuArialItalic.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED), 16);
            for (BangLuongNhanVien blnv : listBLNV) {

                PdfPTable bang = new PdfPTable(2);
                bang.setWidthPercentage(100);


                Paragraph maBL = new Paragraph("Mã bảng lương: " + blnv.getMaBLNV(), contentFont);
                maBL.setAlignment(Element.YMARK);
                maBL.setSpacingAfter(10);
                document.add(maBL);

                Paragraph tieuDe = new Paragraph("PHIẾU LƯƠNG NHÂN VIÊN", titleFont);
                tieuDe.setAlignment(Element.ALIGN_CENTER);
                tieuDe.setSpacingAfter(30);
                document.add(tieuDe);


                String thangNamBL = "Ngày tính lương: " + DateUtils.formatStringVietnamDateCustom(blnv.getNgayTinhLuong(), "dd-MM-yyyy");
                String congTyBL = "Công Ty AHG";
                PdfPTable hangTieuDePhu = new PdfPTable(2);
                hangTieuDePhu.setSpacingAfter(20);
                hangTieuDePhu.setWidthPercentage(100);
                ...
                //Chi Tiet
                /*bang.addCell(new Paragraph(": ", contentFont));
                bang.addCell(new Paragraph(blnv., contentFont));*/
                PdfPCell cell11 = new PdfPCell(new Paragraph("Thông tin: ", titleNormalFont));
                cell11.setPadding(10);
                bang.addCell(cell11);
                PdfPCell cell12 = new PdfPCell(new Paragraph("Chi tiết: ", titleNormalFont));
                ...
                PdfPCell cell21 = new PdfPCell(new Paragraph("Mã nhân viên: ", contentFont));
                cell21.setPadding(10);
                bang.addCell(cell21);
                PdfPCell cell22 = new PdfPCell(new Paragraph(blnv.getMaNhanVien().getMaNV(), contentFont));
                cell22.setPadding(10);
                bang.addCell(cell22);
                ...
                cell31.setPadding(10);
                bang.addCell(cell31);
                PdfPCell cell32 = new PdfPCell(new Paragraph(blnv.getMaNhanVien().getHoNV() + " " + blnv.getMaNhanVien().getTenNV(), contentFont));
                cell32.setPadding(10);
                bang.addCell(cell32);

                PdfPCell cell41 = new PdfPCell(new Paragraph("Phòng ban", contentFont));
                cell41.setPadding(10);
                bang.addCell(cell41);
                PdfPCell cell42 = new PdfPCell(new Paragraph(blnv.getMaNhanVien().getPhongBan().getTenPB(), contentFont));
                cell42.setPadding(10);
                bang.addCell(cell42);
                ...
                cell51.setPadding(10);
                bang.addCell(cell51);
                PdfPCell cell52 = new PdfPCell(new Paragraph(Utils.formatCurrency(blnv.getLuongNV()), currencyFont));
                cell52.setPadding(10);
                bang.addCell(cell52);
                ...
                cell61.setPadding(10);
                bang.addCell(cell61);
                PdfPCell cell62 = new PdfPCell(new Paragraph(Utils.formatCurrency(blnv.getTongLuongNV()), contentFont));
                cell62.setPadding(10);
                bang.addCell(cell62);
